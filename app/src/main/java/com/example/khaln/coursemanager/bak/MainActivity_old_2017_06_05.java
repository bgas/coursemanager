...
//
//public class MainActivity_old_2017_06_05 extends ActionBarActivity
...
//        String[] from = {TermRepo.TITLE};
//        int[] to = {R.id.textViewItem};
//        //cursorAdapter = new ManagerCursorAdapter(this, null, 0);
...
//                Intent intent = new Intent(MainActivity_old_2017_06_05.this, TermDetailsActivity.class);
//                Uri uri = Uri.parse(MyContentProvider.TERM_URI + "/" + id);
//                intent.putExtra(TermRepo.TABLE_NAME /*MyContentProvider.CONTENT_ITEM_TYPE*/, uri);
...
//                            );
//                            restartLoader();
//                            Toast.makeText(MainActivity_old_2017_06_05.this,
